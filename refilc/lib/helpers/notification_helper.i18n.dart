  ...
  static final _t = Translations.byLocale("hu-HU") +
      {
        "en-US": {
          ...
          "body_absence_multiuser":
              "An absence was recorded for %s on %s for the subject %s",
          "title_lesson": "Timetable modified",
          "body_lesson_canceled": "Lesson #%s (%s) has been canceled on %s",
          "body_lesson_canceled_multiuser":
              "(%s) Lesson #%s (%s) has been canceled on %s",
          "body_lesson_substituted":
              "Lesson #%s (%s) on %s will be substituted by %s",
          "body_lesson_substituted_multiuser":
              "(%s) Lesson #%s (%s) on %s will be substituted by %s"
        },
        "hu-HU": {
          "title_grade": "Új jegy",
          "body_grade": "%s: %s",
          "body_grade_multiuser": "(%s) %s: %s",
          "body_grade_surprise":
              "Nyisd meg az alkalmazást a jegyed megtekintéséhez!",
          "title_absence": "Új hiányzás",
          "body_absence": "Új hiányzást kaptál %s napon %s tantárgyból",
          "body_absence_multiuser":
              "%s tanuló új hiányzást kapott %s napon %s tantárgyból",
          "title_lesson": "Órarend szerkesztve",
          "body_lesson_canceled": "%s napon a(z) %s. óra (%s) elmarad",
          "body_lesson_canceled_multiuser":
              "(%s) %s napon a(z) %s. óra (%s) elmarad",
          "body_lesson_substituted":
              "%s napon a(z) %s. (%s) órát %s helyettesíti",
          "body_lesson_substituted_multiuser":
              "(%s) %s napon a(z) %s. (%s) órát %s helyettesíti"
        },
        "de-DE": {
          ...
          "body_absence_multiuser":
              "Für %s wurde am %s für das Thema Mathematik eine Abwesenheit aufgezeichnet",
          "title_lesson": "Fahrplan geändert",
          "body_lesson_canceled": "Lektion Nr. %s (%s) wurde am %s abgesagt",
          "body_lesson_canceled_multiuser":
              "(%s) Lektion Nr. %s (%s) wurde am %s abgesagt",
          "body_lesson_substituted":
              "Lektion Nr. %s (%s) wird am %s durch %s ersetzt",
          "body_lesson_substituted_multiuser":
              "(%s) Lektion Nr. %s (%s) wird am %s durch %s ersetzt"
        },
      };
  String get i18n {
