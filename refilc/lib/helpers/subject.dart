...
class SubjectIconData {
  ...
  SubjectIconData({
    this.data = const {
      ...
      IconPack.cupertino: Icons.widgets_outlined,
    },
    this.name = "square.grid.2x2",
  });
}

SubjectIconVariants createIcon({required IconData material}) {
  return {
    IconPack.material: material,
    IconPack.cupertino: material,
  };
}
  ...
  static SubjectIconData _resolve(
    ...
    if (RegExp("mate(k|matika)").hasMatch(name) || category == "matematika") {
      return SubjectIconData(
          data: createIcon(material: Icons.calculate_outlined),
          name: "function");
    } else if (RegExp("magyar nyelv|nyelvtan").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.spellcheck_outlined),
          name: "textformat.alt");
    } else if (RegExp("irodalom").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.menu_book_outlined),
          name: "book");
    } else if (RegExp("tor(i|tenelem)").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.explore_outlined),
          name: "safari");
    } else if (RegExp("foldrajz").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.public_outlined),
          name: "map");
    } else if (RegExp("rajz|muvtori|muveszet|vizualis").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.palette_outlined),
          name: "paintbrush");
    } else if (RegExp("fizika").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.emoji_objects_outlined),
          name: "lightbulb");
    } else if (RegExp("^enek|zene|szolfezs|zongora|korus").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.music_note_outlined),
          name: "music.note");
    } else if (RegExp("^tes(i|tneveles)|sport|edzeselmelet").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.sports_soccer_outlined),
          name: "sportscourt");
    } else if (RegExp("kemia").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.science_outlined),
          name: "testtube.2");
    } else if (RegExp("biologia").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.pets_outlined),
          name: "pawprint");
    } else if (RegExp(
            "kornyezet|termeszet ?(tudomany|ismeret)|hon( es nep)?ismeret")
        .hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.eco_outlined),
          name: "arrow.3.trianglepath");
    } else if (RegExp("(hit|erkolcs)tan|vallas|etika|bibliaismeret")
        .hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.favorite_border_outlined),
          name: "heart");
    } else if (RegExp("penzugy").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.savings_outlined),
          name: "dollarsign");
    } else if (RegExp("informatika|szoftver|iroda|digitalis").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.computer_outlined),
          name: "laptopcomputer");
    } else if (RegExp("prog").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.code_outlined),
          name: "chevron.left.forwardslash.chevron.right");
    } else if (RegExp("halozat").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.wifi_tethering_outlined),
          name: "antenna.radiowaves.left.and.right");
    } else if (RegExp("szinhaz").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.theater_comedy_outlined),
          name: "hifispeaker");
    } else if (RegExp("film|media").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.theaters_outlined),
          name: "film");
    } else if (RegExp("elektro(tech)?nika").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.electrical_services_outlined),
          name: "bolt");
    } else if (RegExp("gepesz|mernok|ipar").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.precision_manufacturing_outlined),
          name: "wrench");
    } else if (RegExp("technika").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.build_outlined),
          name: "hammer");
    } else if (RegExp("tanc").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.speaker_outlined),
          name: "music.mic");
    } else if (RegExp("filozofia").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.psychology_outlined),
          name: "bubble.left");
    } else if (RegExp("osztaly(fonoki|kozosseg)|kozossegi|neveles")
            .hasMatch(name) ||
        name == "ofo") {
      return SubjectIconData(
          data: createIcon(material: Icons.groups_outlined),
          name: "person.3");
    } else if (RegExp("gazdasag").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.account_balance_outlined),
          name: "chart.pie");
    } else if (RegExp("szorgalom").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.verified_outlined),
          name: "checkmark.seal");
    } else if (RegExp("magatartas").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.emoji_people_outlined),
          name: "face.smiling");
    } else if (RegExp(
            "angol|nemet|francia|olasz|orosz|spanyol|latin|kinai|nyelv")
        .hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.translate_outlined),
          name: "globe");
    } else if (RegExp("linux").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.terminal_rounded));
    } else if (RegExp("adatbazis").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.table_chart),
          name: "table.badge.more");
    } else if (RegExp("asztali alkalmazasok").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.desktop_windows_outlined),
          name: "macwindow");
    } else if (RegExp("projekt").hasMatch(name)) {
      return SubjectIconData(
          data: createIcon(material: Icons.groups_3),
          name: "person.3.fill");
    }
