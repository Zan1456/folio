...
import 'package:folio/utils/color.dart';
import 'package:folio_mobile_ui/common/bottom_card.dart';
...
import 'package:folio/helpers/update_helper.dart';
        ...
        children: [
          ...
          Center(
            child: kIsPlayStore
                ...
                : MaterialActionButton(
                    backgroundColor: AppColors.of(context).filc,
                    onPressed: state == UpdateState.none
                        ? () => downloadPrecheck()
                        : null,
                    child: Row(
