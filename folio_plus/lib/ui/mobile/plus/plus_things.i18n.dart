  ...
  static final _t = Translations.byLocale("hu-HU") +
      {
        "en-US": {
          ...
          "u_desc_11": "With Folio+ lowest tier it's also available!",
          "u_desc_12": "Sync your time-table with Folio+ Gold!",
          "u_desc_13": "You can export every year's grades with Folio+!",
          // button
          "subscribe": "Subscribe",
          "subscriber": "Subscribed",
          // other
          "copy_code_asap":
              "Copy your Folio+ ID, in case you loose your device!",
        },
        "hu-HU": {
          // upsell titles
          ...
          "u_desc_2":
              "Fizess elő Folio+-ra, hogy előre megkapd a béta frissítéseket.",
          "u_desc_3": "Az egyedi üdvözléshez elég csupán a legalsó szint!",
          "u_desc_4": "Támogass minket, és jegyezd fel minden fontos dolgod.",
          "u_desc_5": "Folio+-al egyszerűbb kiszámolnod a tervezett átlagod.",
          ...
          "u_desc_11": "A Folio+ alap szintjével ez is elérhető!",
          "u_desc_12": "Szinkronizáld az órarended Folio+ Gold-al!",
          "u_desc_13": "Minden évi jegyedet exportálhatod Folio+-al!",
          // button
          "subscribe": "Előfizetés",
          "subscriber": "Előfizetve",
          // other
          "copy_code_asap":
              "Másold ki a Folio+ ID-t, mielőtt elveszítenéd a telefonod!",
        },
        "de-DE": {
          // upsell titles
          ...
          "u_desc_11":
              "Mit Folio+ niedrigstem Abo-Plan ist es auch Verfügbar!",
          "u_desc_12": "Synchronisiere deinen Stundenplan mit Folio+ Gold!",
          "u_desc_13": "Du kannst jede Jahresnote mit Folio+ exportieren!",
          // button
          "subscribe": "Abonnieren",
          "subscriber": "im Abonnement",
          // other
          "copy_code_asap":
              "Kopieren Sie Ihre Folio+ ID, bevor Sie Ihr Handy verlieren!",
        },
      };
