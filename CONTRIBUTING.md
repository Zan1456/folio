...
Kérünk, olyan dologgal járulj hozzá a **Folio**hoz, ami valószínűleg **sok embernek hasznos lehet**. Szeretnénk egy minél teljeskörűbb iskolai asszisztenst létrehozni, de az iskolaspecifikus, vagy külön neked hasznos funkciók helye inkább legyen a saját Fork-od.
...
A legjobban annak örülünk, ha az [Issues](https://github.com/Zan1456/folio/issues) oldalról szemezgetsz. Ha még új vagy a Flutterben, ajánljuk figyelmedbe a viszonylag könnyen javítható hibákat, ha éppen van ilyen.
...
A **Folio** legfrissebb, verzióját a [master](https://github.com/Zan1456/folio)-en találod. Kérjük ide Commit-olj és ide célozd a Fork-odból a Pull Request-edet. Írd le benne, hogy mit változtattál és ha lehet, csatolj képernyőképet is a működő építésedből.
...
1. Forráskód letöltése:
   ...
   ```sh
   git clone https://github.com/Zan1456/folio.git
   cd app-legacy
   ```
...
5. Az alkalmazás építése:Menj be a `refilc` mappába
