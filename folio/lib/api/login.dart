...
import 'package:folio/api/nonce.dart';
...
Future loginAPI({
  ...
  switch (instituteCode) {
    ...
    case 'folio-test-sweden':
      School school = School(
        city: "Stockholm",
        instituteCode: "folio-test-sweden",
        name: "Folio Test SE - Leo Ekström High School",
      );

      await testLogin(school);
      break;
    case 'folio-test-spain':
      School school = School(
        city: "Madrid",
        instituteCode: "folio-test-spain",
        name: "Folio Test ES - Emilio Obrero University",
      );
